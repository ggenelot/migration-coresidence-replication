...
place <- "all"
  ...
  for (i in 1:2) {
    # OLS regression
    ols_model <- lm(HHnewmember_allperiod ~ HHusmig_allperiod + HHusmig_fem_allperiod + factor(id_panelgroup) + control, data = subset(final_data_combined, samplee)) #erreur ici, j'essaie de retirer control
    ...
    fe_model <- lm(HHnewmember_allperiod ~ HHusmig_allperiod + HHusmig_fem_allperiod + factor(id_panelgroup) + control, data = subset(final_data_combined, samplee))
