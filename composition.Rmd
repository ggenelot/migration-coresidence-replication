...
#place <- "all"
  ...
  for (i in 1:2) {
    ...
    # 
    # # Obtenir les valeurs du test de F
    # F_test <- summary_ols$fstatistic
    # F_value <- F_test[1]
    # F_p_value <- F_test[3]
    # 
    # # Créer une table de régression
    ...
    #   dep.var.labels = "HHnewmember_allperiod",
    #   covariate.labels = c("HHusmig_allperiod", "HHusmig_fem_allperiod",       paste("id_panelgroup", levels(final_data_combined$id_panelgroup),        sep = "_"), "control"),
    #   omit.stat = c("ser", "f"),
    #   single.row = TRUE,
    #   star.cutoffs = c(0.05, 0.01, 0.001),
    #   add.lines = list(c("Household controls", "X"), 
    #                    c("Municipality FE", ""), 
    #                    c("Average non-migrant", av1), 
    #                    c("F-test controls", F_value)),
    #   add.lines.after = "\\end{tabular}"
    # )

    # Afficher la table de régression
    ...
    #write.csv(ols_output, file = paste0("output/ols/ols_output_", place, "_", i, ".csv"), row.names = TRUE)
    ...
    #write.csv(fe_output, file = paste0("output/fe/fe_output_", place, "_", i, ".csv"), row.names = TRUE)
